...
public enum ParticleEffect {
	...
	/**
	 * Displays a single particle which flies into a determined direction and is only visible for all players within a certain range in the world of @param
	 * center
	 * 
	 * @param direction
	...
	/**
	 * Displays a single particle which requires additional data that flies into a determined direction and is only visible for all players within a certain
	...
	/**
	 * Represents the color for effects like {@link ParticleEffect#SPELL_MOB}, {@link ParticleEffect#SPELL_MOB_AMBIENT}, {@link ParticleEffect#REDSTONE} and
	...
	/**
	 * Represents a runtime exception that is thrown either if the displayed particle effect requires data and has none or vice-versa or if the data type is
	 * incorrect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				String v = PackageType.getServerVersion();
				int i = -123;
				try {
					i = Integer.parseInt(Character.toString(v.charAt(4)));
					version = Integer.parseInt(Character.toString(v.charAt(3))) * 10 + i;
				} catch (NumberFormatException e) {
					version = Integer.parseInt(Character.toString(v.charAt(3)));
				}
				if (version > 7) {
